...
function main() {
  ...
  opts['po-headers'] = opts['po-headers'] || {};
  if (opts['project-id-version']) opts['po-headers']['project-id-version'] = opts['project-id-version'];
  if (opts['report-bugs-to']) opts['po-headers']['report-msgid-bugs-to'] = opts['report-bugs-to'];
